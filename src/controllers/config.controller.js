...
exports.getSerwiseConfig = getSerwiseConfig;
exports.getRadixConfig = getRadixConfig;
 ...
 */
async function getSerwiseConfig(req, res) {
    const config = {
 ...
 */
async function getRadixConfig(req, res) {
    const config = {
        backendUrl: process.env.BACKEND_URL,
        supabaseUrl: process.env.SUPABASE_URL,
        supabaseAnonKey: process.env.SUPABASE_ANON_KEY,
