 ...
 */
export declare function updateProfileImage(_id: mongodbId, profileImageUrl: string): Promise<ApiSuccessType<userApiData>>;
/**
 * Updates a user's basic info.
 */
export declare function updateSelfInfo(_id: mongodbId, data: {
    firstName?: string;
    lastName?: string;
    profileImage?: string;
    email?: string;
