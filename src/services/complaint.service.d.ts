...
export declare const listOpenComplaintsByProvider: (providerId: mongodbId) => Promise<ApiSuccess<{
    complaints: (import("mongoose").Document<unknown, {}, IComplaint, {}, {}> & IComplaint & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
...
export declare const requestEntranceScan: (complaintId: mongodbId, providerId: mongodbId) => Promise<ApiSuccess<null>>;
