...
router.get("/provider/open", auth_middleware_1.auth, complaintController.listOpenProviderComplaints);
...
router.post("/:id/qr/request-scan", auth_middleware_1.auth, complaintController.requestEntranceScan);
