...
export declare const retrieveUserByRefreshToken: (refreshToken: string) => Promise<UserDocument | null>;
export declare const updateUserById: (_id: mongodbId, data: Partial<IUser>) => Promise<UserDocument | null>;
