...
exports.updateUserById = exports.retrieveUserByRefreshToken = exports.retrieveAllUsers = exports.retrieveUserByRefCode = exports.retriveUserById = exports.createUser = exports.retriveUserByEmail = exports.retriveUserByPhoneNo = void 0;
...
const retrieveUserByRefreshToken = async (refreshToken) => {
    if (!refreshToken || typeof refreshToken !== "string") {
        return null;
    }
    return User_schema_1.default.findOne({ refreshToken, isDeleted: false });
};
exports.retrieveUserByRefreshToken = retrieveUserByRefreshToken;
